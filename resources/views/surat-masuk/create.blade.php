...
<div class="card shadow-sm border-0 p-4 mb-4" 
    ...
    <h4 class="text-dark fw-bold mb-4"><i class="fa-solid fa-plus"></i> Tambah Surat Masuk</h4>

    <form method="POST" action="/surat/simpan" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="mb-3 col-md-6">
                ...
                <input type="date" name="tanggal_terima" class="form-control" required style="border-radius:12px; padding:12px;">
            </div>
        </div>

        <div class="mb-3">
            <label class="form-label fw-semibold">Pengirim</label>
            <input type="text" name="pengirim" class="form-control" placeholder="Nama pengirim" required style="border-radius:12px; padding:12px;">
        </div>
