...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="text-dark fw-bold"><i class="fa-solid fa-envelope-open-text"></i> Arsip Surat Keluar</h4>
    <a href="/surat-keluar/tambah" class="btn btn-primary shadow-sm">
        ...
        <table class="table table-bordered align-middle mb-0">
            ...
            <tbody>
                ...
                <tr style="transition: all 0.2s ease;">
                    ...
                    <td>
                        @if($s->file_surat)
                        <a href="/surat-keluar/preview/{{ $s->id }}" class="btn btn-sm btn-info shadow-sm">
                    ...
                    <td>
                        <a href="/surat-keluar/edit/{{ $s->id }}" class="btn btn-sm btn-warning shadow-sm">
                            <i class="fa-solid fa-pen"></i>
                        </a>
                        <a href="/surat-keluar/hapus/{{ $s->id }}" 
